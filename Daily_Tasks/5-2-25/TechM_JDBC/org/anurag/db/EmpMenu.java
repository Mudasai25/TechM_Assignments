...
public class EmpMenu {
	public static void main(String arg[]) throws SQLException,Exception{
		...
		do {
			...
			case 2:{
				PreparedStatement ps1=con.prepareStatement("update into employee set emp_name=? where emp_id=?");
			...
			case 3:{
				PreparedStatement ps2=con.prepareStatement("delete from employee where emp_id=?");
